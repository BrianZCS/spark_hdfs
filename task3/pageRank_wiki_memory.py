...
def main():
    ...
    lines_0 = spark.read.text(files_name[0]).rdd.map(lambda r: r[0])
    ...
    final_ranks.write.option("header", "true").csv("hdfs://10.10.1.1:9000/data/output_wiki_memory", mode = "overwrite")
